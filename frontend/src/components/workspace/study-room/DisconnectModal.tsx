...
export default function DisconnectModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-sm rounded-xl bg-bg-card border border-fade-border shadow-2xl p-6 text-center sr-fade-in">
        ...
        <div className="flex gap-3">
          <button
            onClick={onWait}
            className="flex-1 py-2.5 rounded-lg border border-fade-border bg-white/[0.04] text-text-secondary text-sm font-medium hover:bg-white/[0.08] transition-colors"
          >
            Wait
          </button>
          <button

...
export default function CreateWorkspaceCard({ onOpen }: CreateWorkspaceCardProps) {
  return (
    <button
      type="button"
      onClick={onOpen}
      className="flex h-full min-h-[220px] flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-white/20 bg-white/5 p-6 text-center text-white/70 transition hover:border-white/40 hover:bg-white/10"
    >
